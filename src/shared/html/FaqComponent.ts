  ...
  override render() {
   ...
   <h2>FAQ</h2>
      ...
      <p>dmvboardgames.com has enough money to cover costs through the end of 2028. If additional money is necessary to supprot new features, it will come through donations.
        This site is an open source non-commercial project, and my long term goal is to have dmvboardgames.com run by a non-profit. </p>
      ...
      <h3>I want to make my own website. Can I use code from dmvboardgames.com?</h3>
      
      <p>All code for dmvboardgames.com is publicly available under the GNU General Public License v3.0 <a href="https://github.com/gatherspiel">here</a>, and
         people are encouraged to use the code in order to build their own websites. The site is built using
